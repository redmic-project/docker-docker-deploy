...
do
	echo -e "\n${INFO_COLOR}Checking deployment of service ${NULL_COLOR}${serviceToCheck}${INFO_COLOR} ..${NULL_COLOR}"
	...
	checkDeployCmd="\
		...
		do \
			...
			then \
				...
				then \
					echo -e \"${PASS_COLOR}Service ${NULL_COLOR}${serviceToCheck}${PASS_COLOR} is running!${NULL_COLOR}\" && \
